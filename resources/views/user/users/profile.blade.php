            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <form class="border px-4 pt-2 pb-3" method="POST"
                        action="{{ route('user-profile-update', $profile->id) }}" accept-charset="UTF-8"
                        ...
                        {{-- @error('cover_photo') --}}
                        <label for="inputPhoto" class="col-form-label">Cover Photo</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn ">
                                    <input name="cover_photo" type="file" id="cover_photo" />
                                </span>
                            </div>
...
<style>
    ...
    .image {
        background: url('{{ asset('backend/img/avatar.png') }}');
        height: 150px;
