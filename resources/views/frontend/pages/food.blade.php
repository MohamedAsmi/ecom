					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);">Food List</a></li>
							</ul>
						</div>
					</div>
				</div>
												...
												<div class="col-lg-4 col-md-6 col-sm-6">
													<div class="single-product">
														<div class="product-img">
															...
															@endphp
															<img class="default-img" src="https://foodsafetytrainingcertification.com/wp-content/uploads/2019/08/catering_wedding_reception_food_safety_illness_003_shutterstock_522611404.jpg" alt="">
