        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-6 main">
                ...
                <div class="single-banner wt p-3">
                    <div class="shop_header row ">
                        <p class="col-8">{{$data->service_type}}</p>
                        <p class="col-4">${{$data->price}} only</p>
                        <h4 class="col-12 pb-3" style="border-bottom: 1px solid #f1f1f1;">{{$data->company_name }}</h4>

                    </div>
                    <p class="pt-3 pb-2" style="color: #818181;">{{$data->description}}</p>
                    @php
                    $sh_items = explode('|*|',$data->details_of_service);
                    $co = count($sh_items);
                    @endphp
                    <div class="row">
                        @for ($i=0; $i < $co; $i++) <span class="col-6">
                            <i class="fa-brands fa-servicestack"></i> {{$sh_items[$i]}}
                            </span>
                            @endfor
                    </div>
...
<script>
    ...
    $('.midium-banner .single-banner').hover(function() {
        $(this).closest('.main').find('.single-banner').addClass('hover-style');
    }, function() {
        $(this).closest(".main").find('.single-banner').removeClass('hover-style')
    });
</script>
